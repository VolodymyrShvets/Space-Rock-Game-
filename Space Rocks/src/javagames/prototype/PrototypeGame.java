...
public class PrototypeGame extends SimpleFramework {
    ...
    //creates random stars for the background
    ...
    protected void processInput(float delta) {
        ...
        ship.setThrusting(keyboard.keyDown(KeyEvent.VK_W));
    }
    ...
    protected void render(Graphics g) {
        //render instructions
        super.render(g);
        g.drawString("Rotate: A/S keys", 20, 35);
        g.drawString("Thrust: W key", 20, 50);
