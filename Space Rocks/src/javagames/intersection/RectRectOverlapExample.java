...
public class RectRectOverlapExample extends SimpleFramework {
    ...
    private Vector2f[] rect0, rect1;
    private Vector2f rect0Pos, rect1Pos;
    private float rect0Angle, rect1Angle;
    ...
    public RectRectOverlapExample() {
        ...
        appHeight = 640;
        appSleep = 10L;
        appTitle = "RectRectOverlapExample";
    ...
    protected void processInput(float delta) {
        ...
        rect1Pos = getRelativeWorldMousePosition();
        // rotate rectangles
    ...
    private boolean rectRectIntersection(Vector2f[] A, Vector2f[] B) {
        ...
        Vector2f CA = A[0].sub(A[2]).div(2.0f);
        float D0 = N0.len();
        float D1 = N1.len();
        N1 = N1.div(D1);
        N0 = N0.div(D0);
        ...
        Vector2f CB = B[0].sub(B[2]).div(2.0f);
        float D2 = N2.len();
        float D3 = N3.len();
        N2 = N2.div(D2);
        N3 = N3.div(D3);
    ...
    protected void render(Graphics g) {
        ...
        // draw rectangles
        g.setColor(intersection ? Color.BLUE : Color.ORANGE);
