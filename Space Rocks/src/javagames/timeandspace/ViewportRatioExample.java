...
public class ViewportRatioExample extends JFrame implements Runnable {
    ...
    protected void createAndShowGUI() {
        ...
        setLayout(null);
        setTitle("Viewport Ratio Example");
        setSize(640, 640);
    ...
    public static void main(String[] args) {
        final ViewportRatioExample app = new ViewportRatioExample();
