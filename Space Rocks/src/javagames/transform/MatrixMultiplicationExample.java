...
public class MatrixMultiplicationExample extends JFrame implements Runnable {
    ...
    private void render(Graphics g) {
        ...
        sunMat = sunMat.mul(Matrix3x3f.translate(SCREEN_W / 2, SCREEN_W / 2));
    ...
    public static void main(String[] args) {
        final MatrixMultiplicationExample app = new MatrixMultiplicationExample();
